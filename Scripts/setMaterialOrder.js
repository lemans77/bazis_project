...
const forEachInList = (list) => {
	...
	for (let i = 0; i < list.Count; i++) {
		...
		else if (item instanceof TDraftBlock) { obj.arrTFurnBlock.push(item) }
		else if (item instanceof TFurnBlock && item.JointData) { obj.arrFastSchemes.push(item) }
